...
@section('content')
    <form action="{{route('procesos.update', $proceso->id)}}" method="POST">
        ...
        <input type="text" name="nombre" class="form-control" placeholder="nombre" value="{{$proceso->nombre}}">
        @error('nombre')
        <small>*{{$message}}</small>
        <br><br>
        @enderror
        ...
        <input type="text" name="caratula" class="form-control" placeholder="nombre" value="{{$proceso->caratula}}">
        @error('caratula')
        <small>*{{$message}}</small>
        <br><br>
        @enderror
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <select name="jurisdiccion" id="" class="form-control">
                    <option value="{{$proceso->jurisdiccion}}">{{$proceso->jurisdiccion}}</option>
        ...
        <select name="objeto" id="" class="form-control">
            <option value="{{$proceso->objeto}}">{{$proceso->objeto}}</option>
        ...
        <input type="text" name="numeroCausa" class="form-control" placeholder="Nº" value="{{$proceso->numeroCausa}}">
        @error('numeroCausa')
        <small>*{{$message}}</small>
        <br><br>
        @enderror
        ...
        <input type="text" name="tribunal" class="form-control" placeholder="" value="{{$proceso->tribunal}}">
        @error('tribunal')
        <small>*{{$message}}</small>
        <br><br>
        @enderror
        ...
        <button  class="btn btn-danger btn-sm" type="submit">Actualizar proceso</button>
    </form>
@stop
